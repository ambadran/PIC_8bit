...
void init_MPU6050() {
    ...
    // bit2 & 1 & 0 - reserved
    //
    // setting full scale range = ±250 degree/sec, value = 0b00
    sendI2C1(MPU6050_ADDRESS, GYRO_CONFIG, 0b00011000);
    /**************************************************************************/
    ...
    // bit2 & 1 & 0 - reserved
    //
    // setting full-scale range to ±2g, value = 0b01
    sendI2C1(MPU6050_ADDRESS, ACCEL_CONFIG, 0b00011000);
    /**************************************************************************/
...
uint8_t read_TEMPERATURE_H() {
    return readI2C1(MPU6050_ADDRESS, TEMP_OUT_H);
}

uint8_t read_TEMPERATURE_L() {
    return readI2C1(MPU6050_ADDRESS, TEMP_OUT_L);
}
/******************************************************************************/
/******************************************************************************/
/******************************************************************************/
...
/******************************************************************************/
/************************ Sending Gyroscope OUTPUT **************************/
/******************************************************************************/
void send_GYRO(uint8_t axe) {
    
    if(axe == 0) { // X-Axis
        print(71); //TODO: try writing
    }
